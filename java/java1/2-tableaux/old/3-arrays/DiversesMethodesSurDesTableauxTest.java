...
public class DiversesMethodesSurDesTableauxTest {
	...
	public static final void testMinMaxOccurrences() {

		assertEquals ("cas tableau longueur 0", -1, DiversesMethodesSurDesTableaux.nbMinMaxOccurrences(new int[0], 1, 20));

		assertEquals ("cas tableau min > max", -1, DiversesMethodesSurDesTableaux.nbMinMaxOccurrences(new int[0], 20, 1));

		int[] tabMinMax = {2,3,-7,13,22,0};
		assertEquals ("cas tableau longueur > 0, 3 valeurs", 3, DiversesMethodesSurDesTableaux.nbMinMaxOccurrences(tabMinMax, 1, 20));

		int[] tabMinMaxx = {2,3,8,1,0,22,15};
		assertEquals ("cas tableau longueur > 0, aucune valeur", 0, DiversesMethodesSurDesTableaux.nbMinMaxOccurrences(tabMinMaxx, 9, 14));

		int[] tabMinMaxxx = {2,3,8,19,12,22,15};
		assertEquals ("cas tableau longueur > 0, toutes les valeurs", 7, DiversesMethodesSurDesTableaux.nbMinMaxOccurrences(tabMinMaxxx, 1, 25));
	...
	public static final void testPlusGrandPositif() {
		...
		assertEquals ("cas tableau longueur > 0, max en pos 1", 22.4, DiversesMethodesSurDesTableaux.plusGrandPositif(maxEnPremier),0.0);

		double[] maxEnDernier = {12.4,-3.9,-7,13,-22,18.6};
		assertEquals ("cas tableau longueur > 0, max en dernière pos", 18.6, DiversesMethodesSurDesTableaux.plusGrandPositif(maxEnDernier),0.0);

		double[] maxAuMilieuEtMax0 = {-22.4,-3.9,-7,0.0,-22,-18.6};
		assertEquals ("cas tableau longueur > 0, max au milieu", 0.0, DiversesMethodesSurDesTableaux.plusGrandPositif(maxAuMilieuEtMax0),0.0);
